...
<ul>
  ...
  // Verificar si existe información para el jugador seleccionado
  if (playerInfo[playerName]) {
    playerInfoDiv.innerHTML = playerInfo[playerName];
    playerModal.style.display = 'block';  // Mostrar el modal
  } else {
    console.error("No se encontró información para el jugador: " + playerName);
  }
}
